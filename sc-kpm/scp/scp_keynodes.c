...
// Debugging
scp_operand nrel_breakpoints;
scp_operand breakpoint;
scp_operand scp_paused_operator;
scp_operand scp_unpaused_operator;
scp_operand scp_debug_execution_program;
scp_operand scp_debug_executing_process;
...
scp_result scp_keynodes_init()
{
    ...
    MAKE_DEFAULT_OPERAND_FIXED(nrel_breakpoints);
    MAKE_DEFAULT_OPERAND_FIXED(breakpoint);
    MAKE_DEFAULT_OPERAND_FIXED(scp_paused_operator);
    MAKE_DEFAULT_OPERAND_FIXED(scp_unpaused_operator);
    MAKE_DEFAULT_OPERAND_FIXED(scp_debug_execution_program);
    MAKE_DEFAULT_OPERAND_FIXED(scp_debug_executing_process);
    ...
    resolve_keynode(nrel_breakpoints.addr, "nrel_breakpoints");
    resolve_keynode(breakpoint.addr, "breakpoint");
    resolve_keynode(scp_paused_operator.addr, "scp_paused_operator");
    resolve_keynode(scp_unpaused_operator.addr, "scp_unpaused_operator");
    resolve_keynode(scp_debug_execution_program.addr, "scp_debug_execution_program");
    resolve_keynode(scp_debug_executing_process.addr, "scp_debug_execution_process");
